...
public class AdapterShowTop extends BaseAdapter {
    Context context;
    ArrayList<HOADONCHITIET> list;

    public AdapterShowTop(Context context, ArrayList<HOADONCHITIET> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.one_sach_hdctsales, null);
